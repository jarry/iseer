...
=======================================
# 用root登录
$ mysql/bin>iseer -h localhost -u root

# 授权iseer用户以localhost访问数据库
iseer> GRANT ALL PRIVILEGES ON iseer.* TO 'iseer'@'localhost' IDENTIFIED BY 'iseer798' WITH GRANT OPTION;

# 授权iseer用户以任何主机ip访问数据库
iseer> GRANT ALL PRIVILEGES ON iseer.* TO 'iseer'@'%' IDENTIFIED BY 'iseer798';
